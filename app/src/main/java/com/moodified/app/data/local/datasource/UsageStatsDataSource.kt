    ...
    constructor(
        ...
        fun queryDayStats(
            ...
            return try {
                ...
                Log.e(TAG, "UsageStats permission denied: ${e.message}")
                null
            } catch (e: Exception) {
                Log.e(TAG, "queryDayStats failed: ${e.message}")
                null
            }
        }
        ...
        private fun parseEvents(
            ...
            var unlockCount = 0
            var sessionStart = -1L
            val sessionList = mutableListOf<com.moodified.app.domain.model.interaction.InteractionSession>()
                        ...
                        if (sessionStart > 0L) {
                            ...
                            if (sessionEnd > sessionStart) {
                                ...
                                if (duration <= MAX_SESSION_GAP_MS) {
                                    ...
                                    if (durationMins > 0) {
                                        sessionList.add(
                                            com.moodified.app.domain.model.interaction.InteractionSession(
        ...
        private fun lateNightOverlapMs(
            startMs: Long,
            endMs: Long,
            zone: ZoneId,
        ): Long {
            ...
            return try {
                ...
                while (events.hasNextEvent() && count < 5) {
                    ...
                    if (ev.eventType == UsageEvents.Event.SCREEN_NON_INTERACTIVE ||
                        ev.eventType == UsageEvents.Event.SCREEN_INTERACTIVE
                    ) {
                        count++
                    }
                }
        ...
        data class DayStats(
            ...
            val unlockCount: Int,
            val sessions: List<com.moodified.app.domain.model.interaction.InteractionSession>,
        ) {
