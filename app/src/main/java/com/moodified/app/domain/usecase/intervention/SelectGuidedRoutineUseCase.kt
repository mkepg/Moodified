...
class SelectGuidedRoutineUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        val candidates = when {
            ...
            moodState.valence == Valence.NEGATIVE && moodState.arousal == Arousal.LOW -> listOf(
            ...
            hour in 18..20 -> listOf(
                ...
                buildRecoveryBreakRoutine() // Reused here as a decompression tool
            )
            // Daytime Sluggishness / Focus (10:00 - 17:59)
            moodState.arousal == Arousal.LOW && hour in 10..17 -> listOf(
        ...
        val availableCandidates = candidates.filter {
    ...
    private fun buildWelcomeRoutine() = InterventionAction.GuidedRoutine(
        id = "routine_welcome",
        priority = 100,
        phases = listOf(
    ...
    private fun buildWindDownRoutine() = InterventionAction.GuidedRoutine(
    ...
    private fun buildEveningReflectionRoutine() = InterventionAction.GuidedRoutine(
    ...
    private fun buildEveningTransitionRoutine() = InterventionAction.GuidedRoutine(
    ...
    private fun buildMorningAnchorRoutine() = InterventionAction.GuidedRoutine(
    ...
    private fun buildMorningActivationRoutine() = InterventionAction.GuidedRoutine(
    ...
    private fun buildRecoveryBreakRoutine() = InterventionAction.GuidedRoutine(
    ...
    private fun buildEmotionalGroundingRoutine() = InterventionAction.GuidedRoutine(
    ...
    private fun buildFocusSessionRoutine() = InterventionAction.GuidedRoutine(
    ...
    private fun buildDeepWorkRoutine() = InterventionAction.GuidedRoutine(
