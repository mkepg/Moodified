    ...
    val uiState: StateFlow<CareUiState> = combine(
        ...
        .flatMapLatest { today ->
            ...
            combine(
                ...
                val activeGuidance = actions
                    .filter { it is InterventionAction.Guidance || it is InterventionAction.Motivation }
                    .filterNot { it.id in dismissedIds }

                val trendAlerts = actions.filterIsInstance<InterventionAction.TrendAlert>()
                    .filterNot { it.id in dismissedIds }

                val suggestedRoutine = actions.filterIsInstance<InterventionAction.GuidedRoutine>()
                    .firstOrNull { it.id !in dismissedIds }

                val motivationNudge = actions.filterIsInstance<InterventionAction.MotivationNudge>()
                    .firstOrNull { it.id !in dismissedIds }
        ...
        return listOf(
            ...
            InterventionAction.MicroIntervention(
                ...
                steps = listOf(
                    ...
                    InterventionAction.MicroIntervention.MicroStep("Tuck your chin slightly to align your neck with your spine.", 5),
            ...
            InterventionAction.MicroIntervention(
                ...
                steps = listOf(
                    ...
                    InterventionAction.MicroIntervention.MicroStep("Consider turning on Do Not Disturb for the next 30 minutes.", 20)
                ),
                wellBeingDomain = WellBeingDomain.DIGITAL,
                isAutoAdvance = false
            ),
