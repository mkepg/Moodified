...
class SleepReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (SleepClassifyEvent.hasEvents(intent)) {
            ...
            // Emit to a shared flow/DataStore for the live Dev Monitor
            // Implementation handled in the Repository via SharedPreferences or EventBus for real-time UI updates
