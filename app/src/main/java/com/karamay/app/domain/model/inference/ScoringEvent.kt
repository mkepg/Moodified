 ...
 * Passed from [com.karamay.app.domain.usecase.inference.RuleBasedMoodInferenceEngine] to
 * [com.karamay.app.domain.usecase.inference.MoodExplainabilityGenerator] so that explanations
