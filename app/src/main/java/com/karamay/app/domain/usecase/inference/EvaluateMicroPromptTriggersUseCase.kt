...
class EvaluateMicroPromptTriggersUseCase @Inject constructor(
    ...
    operator fun invoke(
        ...
        if (activity.intensity == ActivityIntensity.MODERATE || activity.intensity == ActivityIntensity.VIGOROUS) {
            ...
            promptPrefs.isCoolingDown = false
            shouldPrompt = true
            activeTrigger = if (promptPrefs.lastActiveIntensity == ActivityIntensity.VIGOROUS.name) {
    ...
    private enum class ContextTrigger {
        POST_VIGOROUS, POST_MODERATE, PROLONGED_REST, SCREEN_FATIGUE, LATE_NIGHT_WIND_DOWN
    }

    private fun getDynamicPrompt(trigger: ContextTrigger, hour: Int): String {
        return when (trigger) {
            ContextTrigger.POST_VIGOROUS -> listOf(
            ...
            ContextTrigger.POST_MODERATE -> listOf(
            ...
            ContextTrigger.PROLONGED_REST -> listOf(
            ...
            ContextTrigger.SCREEN_FATIGUE -> listOf(
            ...
            ContextTrigger.LATE_NIGHT_WIND_DOWN -> listOf(
